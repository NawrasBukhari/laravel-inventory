...
namespace Mcamara\LaravelLocalization\Facades {
    ...
    /**
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::setLocale
     * @method static null|string setLocale(string $locale = null)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLocaleScript
     * @method static string getCurrentLocaleScript()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getSupportedLocales
     * @method static array getSupportedLocales()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::hideDefaultLocaleInURL
     * @method static bool hideDefaultLocaleInURL()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::setSupportedLocales
     * @method static void setSupportedLocales(array $locales)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getLocalesOrder
     * @method static array getLocalesOrder()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getLocaleFromMapping
     * @method static null|string getLocaleFromMapping(null|string $locale)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getNonLocalizedURL
     * @method static false|string getNonLocalizedURL(false|string $url = null)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::localizeURL
     * @method static false|string localizeURL(string $url = null, bool|string $locale = null)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getLocalizedURL
     * @method static false|string getLocalizedURL(bool|string $locale = null, false|string $url = null, array $attributes = [], bool $forceDefaultLocation = false)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::transRoute
     * @method static string transRoute(string $routeName)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getSerializedTranslatedRoutes
     * @method static string getSerializedTranslatedRoutes()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getDefaultLocale
     * @method static string getDefaultLocale()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getInversedLocaleFromMapping
     * @method static null|string getInversedLocaleFromMapping(null|string $locale)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::setSerializedTranslatedRoutes
     * @method static void setSerializedTranslatedRoutes(string $serializedRoutes)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLocaleNativeReading
     * @method static string getCurrentLocaleNativeReading()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLocaleDirection
     * @method static string getCurrentLocaleDirection()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getConfigRepository
     * @method static \Illuminate\Config\Repository getConfigRepository()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::setRouteName
     * @method static void setRouteName(string $routeName)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::checkLocaleInSupportedLocales
     * @method static bool checkLocaleInSupportedLocales(bool|string $locale)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::setBaseUrl
     * @method static void setBaseUrl(string $url)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLocale
     * @method static bool|string getCurrentLocale()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getLocalesMapping
     * @method static array getLocalesMapping()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLocaleRegional
     * @method static string getCurrentLocaleRegional()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getRouteNameFromAPath
     * @method static false|string getRouteNameFromAPath(string $path)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::hideUrlAndAcceptHeader
     * @method static bool hideUrlAndAcceptHeader()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::createUrlFromUri
     * @method static string createUrlFromUri(string $uri)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getSupportedLanguagesKeys
     * @method static array getSupportedLanguagesKeys()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLocaleName
     * @method static string getCurrentLocaleName()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getCurrentLocaleNative
     * @method static string getCurrentLocaleNative()
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::getURLFromRouteNameTranslated
     * @method static false|string getURLFromRouteNameTranslated(bool|string $locale, string $transKeyName, array $attributes = [], bool $forceDefaultLocation = false)
     * @see \Mcamara\LaravelLocalization\LaravelLocalization::isHiddenDefault
...
namespace Monarobase\CountryList {
    ...
    /**
     * @see CountryList::getList
     * @method static array|mixed getList(string $locale = 'en', string $format = 'php')
     * @see CountryList::getDataDir
     * @method static string getDataDir()
     * @see CountryList::getOne
     * @method static string getOne(string $countryCode, string $locale = 'en')
     * @see CountryList::setList
