                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{__('translation.Register_Client')}}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('clients.store') }}" autocomplete="off">
                            @csrf
                            <h6 class="heading-small text-muted mb-4">{{__('translation.Client_Information')}}</h6>
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" name="document_id" id="input-document_id" class="form-control form-control-alternative{{ $errors->has('document_id') ? ' is-invalid' : '' }}"
                                               placeholder="{{__('translation.Document_Number')}}" value="{{ old('document_id') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="email" name="email" id="input-email" class="form-control form-control-alternative{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                           placeholder="{{__('translation.Email')}}" value="{{ old('email') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="phone" id="input-phone" class="form-control form-control-alternative{{ $errors->has('phone') ? ' is-invalid' : '' }}"
                                           placeholder="{{__('translation.Telephone')}}" value="{{ old('phone') }}" required>
