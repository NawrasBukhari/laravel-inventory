@extends('layouts.app', ['page' => 'Edit Product', 'pageSlug' => 'kenzhekhan', 'section' => 'inventory'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('kenzhekhan.index') }}" class="btn btn-sm btn-primary">{{__('translation.Back_to_List')}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('kenzhekhan.update', $kenzhekhan) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('product_category_id') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="product_category_id" id="input-category" class="form-select form-select-sm{{ $errors->has('name') ? ' is-invalid' : '' }}" required>
                                        @foreach ($categories as $category)
                                            @if($category['id'] == old('document') or $category['id'] == $kenzhekhan->product_category_id)
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                           placeholder="{{ __('translation.Name') }}" value="{{ old('name', $kenzhekhan->name) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="description" id="input-description" class="form-control form-control-alternative"
                                           placeholder="{{__('translation.Description')}}" value="{{ old('description', $kenzhekhan->description) }}" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('stock') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="stock" id="input-stock" class="form-control form-control-alternative"
                                                   placeholder="{{__('translation.stock')}}" value="{{ old('stock', $kenzhekhan->stock) }}" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('stock_defective') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="stock_defective" id="input-stock_defective" class="form-control form-control-alternative"
                                                   placeholder="{{__('translation.Defective_Stock')}}" value="{{ old('stock_defective', $kenzhekhan->stock_defective) }}" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" step=".01" name="price" id="input-price" class="form-control form-control-alternative"
                                                   placeholder="Price" value="{{ old('price', $kenzhekhan->price) }}" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('weight') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" step=".01" name="weight" id="input-weight" class="form-control form-control-alternative"
                                                   placeholder="{{__('translation.Weight')}}" value="{{ old('weight', $kenzhekhan->weight) }}" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('product code') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="product_code" id="input-product_code" class="form-control form-control-alternative"
                                                   placeholder="{{__('translation.product_code')}}" value="{{ old('product_code', $kenzhekhan->product_code) }}" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('usage') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="usage" id="input-usage" class="form-control form-control-alternative"
                                                   placeholder="{{__('translation.usage')}}" value="{{ old('usage', $kenzhekhan->usage) }}" required>
