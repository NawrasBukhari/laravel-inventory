@extends('layouts.app', ['page' => 'New Product', 'pageSlug' => 'kenzhekhan', 'section' => 'inventory'])
@section('content')
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('kenzhekhan.store') }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
